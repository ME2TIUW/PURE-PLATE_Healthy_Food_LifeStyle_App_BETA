...
class SushiHiroMapsActivity : AppCompatActivity(), OnMapReadyCallback{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sushihiromaps)
    ...
    fun getLastLocation(){
        ...
        task.addOnSuccessListener { location: Location? ->
            if(location != null) {
                ...
                currentLocation.longitude = 106.79167005484798
                currentLocation.latitude = -6.1755805629785225
    ...
    override fun onMapReady(p0: GoogleMap) {
        ...
        myMap.addMarker(MarkerOptions().position(myLocation).title("Sushi Tei"))
