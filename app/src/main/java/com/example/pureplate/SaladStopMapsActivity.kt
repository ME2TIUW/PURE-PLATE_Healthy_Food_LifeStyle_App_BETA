...
class SaladStopMapsActivity : AppCompatActivity(), OnMapReadyCallback{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_saladstopmaps)
    ...
    fun getLastLocation(){
        ...
        task.addOnSuccessListener { location: Location? ->
            if(location != null) {
                ...
                currentLocation.longitude = 106.7911173220283
                currentLocation.latitude = -6.177249995559845
    ...
    override fun onMapReady(p0: GoogleMap) {
        ...
        myMap.addMarker(MarkerOptions().position(myLocation).title("SaladStop!"))
