...
class SubwayMapsActivity : AppCompatActivity(), OnMapReadyCallback{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subwaymaps)
    ...
    fun getLastLocation(){
        ...
        task.addOnSuccessListener { location: Location? ->
            if(location != null) {
                ...
                currentLocation.longitude = 106.7900995152195
                currentLocation.latitude = -6.17669233665209
    ...
    override fun onMapReady(p0: GoogleMap) {
        ...
        myMap.addMarker(MarkerOptions().position(myLocation).title("Subway"))
